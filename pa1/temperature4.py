...
df = pd.read_excel("kumpulan4.xlsx")
...
# === 6. DATA AKTUAL ===
actual = np.array([28.1, 29, 28.6, 28.5, 28.8, 29.1, 29.1])
...
print("\n=== TABEL HASIL PREDIKSI 22–28 JUNI 2025 ===")
print(results_df)
...
plt.title("Perbandingan Suhu Aktual vs Prediksi (22–28 Juni 2025)")
plt.xlabel("Tanggal")
