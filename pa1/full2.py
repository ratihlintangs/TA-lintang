...
plt.tight_layout()
plt.show()
# === Simpan Semua Hasil Prediksi WS2M ke Satu File CSV ===
...
df_all_prediksi.to_csv("hasil_prediksi_ws2m.csv", index=False)
print("\n✅ File 'hasil_prediksi_ws2m.csv' berhasil disimpan.")
