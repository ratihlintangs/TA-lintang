...
for i in range(7):
    ...
    lag_vals.append(y_lin)  # autoregresif

# === AKTUAL DATA RH (1-7 JUNI) ===
aktual = [83, 82, 76, 76, 68, 71, 71]
...
plt.title("Prediksi RH_Avg (1–7 Juni 2025)")
plt.xlabel("Tanggal")
plt.ylabel("RH_Avg (%)")
